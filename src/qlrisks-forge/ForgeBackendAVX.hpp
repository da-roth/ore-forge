...
//
//  This file is part of QuantLib-Risks-Cpp-Forge, integrating Forge JIT
//  compilation with QuantLib and XAD.
//
...
//
//  When QLRISKS_USE_FORGE_CAPI is defined, this header forwards to
